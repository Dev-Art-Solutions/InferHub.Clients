...
| **TypeScript** — [`js/`](js/) | [`inferhub-client`](https://www.npmjs.com/package/inferhub-client) on npm | `0.1.0` | shipping (core) |
...
js/           the TypeScript client (core — v0.1.0), tests and examples
go/           planned
